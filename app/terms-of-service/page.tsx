      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Testing TikTok Login.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Testing TikTok Login, accessible
            from{" "}
            <a
              href="https://testing-titktok-login.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://testing-titktok-login.vercel.app/
            </a>
          </p>
        </li>
        <li>
